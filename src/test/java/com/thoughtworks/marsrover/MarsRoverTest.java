...
public class MarsRoverTest {
    ...
    public void should_accept_initialization_message_and_send_own_position_and_direct() {
        ...
        marsRover.tell(new MarsRover.Initialization(10.0, 20.0, Direct.W, controlCenter.getRef()));
        marsRover.tell(new MarsRover.GetRoverStatus(controlCenter.getRef()));
    ...
    public void should_move_to_west_1_step_when_receive_move_message() {
        ...
        marsRover.tell(new MarsRover.GetRoverStatus(controlCenter.getRef()));
        controlCenter.expectMessage(new MarsRover.ReceivePositionAndDirect(9.0, 20.0, Direct.W));
        marsRover.tell(new MarsRover.Move(controlCenter.getRef()));
        marsRover.tell(new MarsRover.GetRoverStatus(controlCenter.getRef()));
        controlCenter.expectMessage(new MarsRover.ReceivePositionAndDirect(8.0, 20.0, Direct.W));
    }
    ...
    public void should_turn_direct() {
        ...
        marsRover2.tell(new MarsRover.GetRoverStatus(controlCenter.getRef()));
